...
export const styles = StyleSheet.create({
  ...
  textTipStyle: {
    marginHorizontal: Constant.CHANGE_BY_MOBILE_DPI(16),
    marginTop: Constant.CHANGE_BY_MOBILE_DPI(90),
  },
  btnStyle: {
  ...
  buttonContainer: {
    marginTop: Constant.CHANGE_BY_MOBILE_DPI(120),
  ...
  warnImage: {
    width: Constant.CHANGE_BY_MOBILE_DPI(30.02),
    height: Constant.CHANGE_BY_MOBILE_DPI(27.28),
  },
});
