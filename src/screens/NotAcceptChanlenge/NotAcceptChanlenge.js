  ...
  return (
    <Gradient>
      ...
      <View style={styles.buttonContainer}>
        <View>
          <Image style={styles.warnImage} source={IMAGES.Warn} />
        </View>
        <View>
          <Text style={styles.warnTextStyle}>
            The challenge has already been accepted or
          </Text>
          <Text style={styles.warnTextStyle}>refused.</Text>
        </View>
      </View>
    </Gradient>
  );
...
export default NotAcceptChalenge;
